...
**State as of 2026-07-16:** tree clean, **8 commits ahead of `gh/main`, push awaits
say-so** (Flux-webhook work `977636e..18ab156` + docs sweeps `da0ea2d`/`930a09c`).
Surfaced task list empty — remaining opens are the two handoffs below (push; `./infra`
`[vars]` migration).
